...
autodoc_mock_imports = ["psycopg2", "sklearn.preprocessing",
                        "sklearn.model_selection", "pymc3"]
...
htmlhelp_basename = 'DemandForecastdoc'
...
latex_documents = [
    (master_doc, 'DemandForecast.tex', 'Demand Forecast Documentation',
     'Gamma', 'manual'),
]
...
man_pages = [
    (master_doc, 'demandforecast', 'Demand Forecast Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DemandForecast', 'Demand Forecast Documentation',
     author, 'DemandForecast', 'One line description of project.',
     'Miscellaneous'),
]
...
ddidier_sphinxdoc_image_tag = '2b5b13bd52a6a4208df12813488060ccbe13b2777bb123da0b730b89aef93812'
...
# -- Options for markdown parsing with recommonmark -----------------------
...
MOCK_MODULES = [
    ...
    'sklearn', 'sklearn.ensemble', 'xgboost'
]
